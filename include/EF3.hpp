/*
ELIAS-FANO BUCKET IMPLEMENTATION 3:
...
public:
    ...
    EF3 (std::span<const u64> sorted_vals) : m(sorted_vals.size()) {
...
static_assert(EF<EF3>, "EF3 does not satisfy EF concept");
